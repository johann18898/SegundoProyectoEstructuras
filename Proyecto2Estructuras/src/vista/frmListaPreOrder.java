 ...
 * @author Johann
 */
public class frmListaPreOrder extends javax.swing.JFrame {

    /**
     * Creates new form frmListaPreOrder
     */
    public frmListaPreOrder() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Listar Nodos Pre Order");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmListaPreOrder.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmListaPreOrder().setVisible(true);
            }
        });
    }
